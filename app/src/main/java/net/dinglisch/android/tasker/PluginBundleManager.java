...
public final class PluginBundleManager
{
     ...
     */
    public static Bundle generateBundle(final Context context, final String name, String cmd, int type)
    {
        ...
        result.putString(FnBind.BTN_NAME, name);
        //bundle.putString(BTN_CMD, localeBundle.getString(BTN_CMD));
        result.putString(FnBind.BTN_CMD, cmd);
       //bundle.putInt(BTN_TYPE, localeBundle.getInt(BTN_TYPE));
